import{j as t}from"./index-DBpgOaYB.js";function c({steps:n,current:l,onStep:a}){return t.jsx("nav",{"aria-label":"Progress langkah",className:"mb-6",children:t.jsx("ol",{className:"flex items-center gap-1 overflow-x-auto pb-2",children:n.map((i,s)=>{const r=s===l,e=s<l;return t.jsxs("li",{className:"flex items-center shrink-0",children:[t.jsxs("button",{type:"button",onClick:()=>e&&(a==null?void 0:a(s)),disabled:!e,className:`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold transition
